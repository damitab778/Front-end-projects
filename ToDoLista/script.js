...
const createToolsArea = () => {
    ...
    completeBtn.innerHTML = '<i class="demo-icon icon-ok-outline"></i>';
    
    const editBtn = document.createElement('button');
    editBtn.classList.add('edit');
    editBtn.innerHTML = '<i class="demo-icon icon-cog-outline"></i>';
    
    const deleteBtn = document.createElement('button');
    deleteBtn.classList.add('delete');
    deleteBtn.innerHTML = '<i class="demo-icon icon-cancel-outline"></i>';
